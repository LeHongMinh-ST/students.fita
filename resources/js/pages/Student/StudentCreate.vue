            ...
            <div class="row">
                                            ...
                                            <template v-slot:append>
                                                <q-icon name="event" class="cursor-pointer">
                                                    <q-popup-proxy cover transition-show="scale"
                                                        ...
                                                        <q-date mask="DD/MM/YYYY" :locale="myLocale"
                                                                v-model="student.dob">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <q-input type="textarea" outlined dense id="description"
                                                 v-model="student.note"></q-input>
                                    </div>
                                </div>
                            </div>
                        </q-card-section>
                ...
                <div class="col-3 right-sidebar">
                    <q-card class="widget meta-boxes action-horizontal q-mb-md">
                        ...
                        <q-separator/>
                        <q-card-section>
                            <q-btn :disable="isRequest" @click="handleCreateStudent" no-caps color="secondary"
                                   class="q-mr-sm">
                    ...
                    <q-card>
                        ...
                        <q-card-section>
                            <div class="main-form">
                                <div class="form-group">
                                    <label class="text-bold">Tình trạng sinh viên <span
