        ...
        <q-card class="table-wrapper">
            <q-card-section class="table-wrapper-title">
                ...
                <div class="table-wrapper-action">
                    <q-btn v-if="checkPermission('class-create')" no-caps @click="redirectRouter('ClassesCreate')"
                           color="secondary" class="q-mr-sm">
                ...
                <q-markup-table class="role-table">
                  ...
                  <span @click="redirectRouter('ClassesDetail', {id: getValueLodash(classItem, 'id', 0)})"
                    ...
                    {{ getValueLodash(classItem, 'name', '') }}
                            ...
                            <td class="text-left"> {{
                                    getValueLodash(classItem.department, 'name', 'Không có bộ môn')
                                }}
                            </td>
                            <td class="text-left">
                                {{ getValueLodash(classItem, 'teacher.full_name', 'Không có giáo viên') }}
                            </td>
                            <td class="text-center">{{
                                    handleFormatDate(getValueLodash(classItem, 'created_at', ''))
                                }}
                            </td>
                            <td class="text-center">
