                ...
                <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <q-input
                              outlined
                              dense
                              v-model="auth.citizen_identification"
                  ...
                  <div class="col-9">
                      ...
                      <div class="form-group">
                          ...
                          <q-input outlined dense v-model="auth.dob"
                              ...
                              <template v-slot:append>
                                  <q-icon name="event" class="cursor-pointer">
                                      <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                                          <q-date mask="DD/MM/YYYY" :locale="myLocale" v-model="auth.dob">
                      ...
                      <div class="form-group">
                          ...
                          <q-input
                              outlined
                              dense
                              v-model="auth.permanent_residence"
                      ...
                      <div class="family-wrapper q-mt-lg q-mb-lg">
                          ...
                          <div class="family-list q-pa-md">
                              <div v-for="(item, index) in auth.families" :key="index" class="row">
                      ...
                      <div class="col">
                          <div class="form-group">
                              ...
                              <q-select
                                  ...
                                  v-model="auth.social_policy_object"
                                  emit-value
                                  map-options
                          ...
                          <div class="form-group">
                              ...
                              <q-input type="textarea" outlined dense id="description" v-model="auth.note"></q-input>
                          </div>
                      </div>
                  </div>
              </q-card-section>
...
export default defineComponent({
    ...
    setup() {
          ...
          const addFamily = () => {
              const families = auth.value.families ?? []
              families.push({relationship: '', full_name: '', phone: '', job: ''})
              auth.value.families = families
          }

          const deleteFamily = (id) => {
            auth.value.families = auth.value.families.filter((item, index) => index != id)
          }
          ...
          const handleUpdateStudent = () => {
              if (!isRequest.value) {
                  ...
                  Object.keys(auth.value).map(function (objectKey) {
                      const value = auth.value[objectKey];
                      if (value == null) {
